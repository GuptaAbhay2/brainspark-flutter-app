            ...
            child: Column(children: [
              ...
              Text('Reaction Chain',
                style: GoogleFonts.inter(fontSize: 24,
                  fontWeight: FontWeight.w800, color: Colors.white)),
              const SizedBox(height: 8),
              Text('1 se $_totalCount tak numbers random positions pe honge.\nOrder mein tap karo — as FAST as possible!',
                textAlign: TextAlign.center,
                style: GoogleFonts.inter(fontSize: 13,
              ...
              children: [
                Text('How to Play',
                  style: GoogleFonts.inter(fontSize: 14,
                    fontWeight: FontWeight.w700, color: Colors.white)),
                const SizedBox(height: 12),
                _howRow('1️⃣', 'Grid mein 1 dhundho aur tap karo'),
                _howRow('2️⃣', 'Phir 2, phir 3... order mein jao'),
                _howRow('⚡', 'Jitna fast ho sake utna fast!'),
                _howRow('❌', 'Galat tap karne pe time waste hoga'),
                _howRow('🏆', 'Personal best beat karte raho'),
              ],
            ),
          ),
          const SizedBox(height: 20),
